...
@Component({
  ...
  standalone: true,
  imports: [ReactiveFormsModule, TitleComponent, CommonModule, InputContainerComponent, InputValidationComponent, TextInputComponent, DefaultButtonComponent, RouterModule],
